...
const OFFSETS: Record<string, ReadonlyArray<readonly [string, number, number]>> = {
  ...
  paket: [
    ['IDTEIL', 1, 20], ['REFP', 21, 40], ['BKNR', 61, 10], ['DGNA', 71, 70],
    ['MPKE', 141, 30], ['JAGB', 171, 1], ['DTEL', 172, 50], ['MAIL', 222, 60],
    ['BZRM', 282, 6], ['GSVZ', 288, 1], ['GSUM', 289, 11], ['ANZM', 300, 6],
  ],
  mbgm: [
    ['IDTEIL', 1, 20], ['REFW', 21, 40], ['REFU', 61, 40], ['REFV', 101, 40],
    ['VSNR', 141, 10], ['FANA', 151, 70], ['VONA', 221, 70], ['VSUM', 291, 11],
    ['VERG', 302, 1], ['INF1', 303, 12], ['INF2', 315, 12],
  ],
  tarifblock: [
    ['IDTEIL', 1, 20], ['BSGR', 21, 4], ['ERGB1', 25, 3], ['ERGB2', 28, 3],
    ['ERGB3', 31, 3], ['ERGB4', 34, 3], ['ERGB5', 37, 3], ['VVON', 40, 2],
    ['KEUE', 42, 1],
  ],
  tarifblockFallweise: [
    ['IDTEIL', 1, 20], ['BSGR', 21, 4], ['ERGB1', 25, 3], ['ERGB2', 28, 3],
    ['ERGB3', 31, 3], ['ERGB4', 34, 3], ['ERGB5', 37, 3], ['FTAG', 40, 2],
  ],
  tarifblockKurz: [
    ['IDTEIL', 1, 20], ['BSGR', 21, 4], ['ERGB1', 25, 3], ['ERGB2', 28, 3],
    ['ERGB3', 31, 3], ['ERGB4', 34, 3], ['ERGB5', 37, 3], ['BTAB', 40, 2],
    ['BTBS', 42, 2], ['KEUE', 44, 1],
  ],
  verrechnungsbasis: [
    ['IDTEIL', 1, 20], ['VBTY', 21, 2], ['VBBT', 23, 11],
  ],
  verrechnungsposition: [
    ['IDTEIL', 1, 20], ['VPTY', 21, 3], ['VPVZ', 24, 1], ['VPTA', 25, 6],
    ['RSVZ', 31, 1], ['RSUM', 32, 11],
  ],
};
