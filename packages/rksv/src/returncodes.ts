...
export const RKDB_RC: Record<string, RcInfo> = {
  ...
  '6': {
    kind: 'fachlich',
    text: 'OID für „Österreichische Finanzverwaltung Registrierkasseninhaber" nicht vorhanden',
  },
  '7': {
    kind: 'fachlich',
    text: 'Ordnungsbegriff im Zertifikat nicht dem registrierenden Unternehmen zugeordnet',
  },
  ...
  '13': {
    kind: 'fachlich',
    text: 'SEE-Registrierung nicht möglich: weder Steuernummer, UID noch GLN in der Finanzverwaltung vorhanden',
  },
  ...
  '28': {
    kind: 'fachlich',
    text: 'Angegebener Ordnungsbegriff nicht dem registrierenden Unternehmen zugeordnet',
  },
  ...
  B1: {
    kind: 'fachlich',
    text: 'Registrierkasse mit dieser Kassenidentifikationsnummer ist bereits registriert',
  },
  B2: { kind: 'fachlich', text: 'Für Kassen im vorliegenden Status ist keine Datenänderung möglich' },
  B3: {
    kind: 'fachlich',
    text: 'Kein Ordnungsbegriff (Steuernummer, GLN, UID) für das Unternehmen ermittelbar',
  },
  B4: INTERN('B4'),
  ...
  B8: {
    kind: 'fachlich',
    text: 'Nur in Betrieb/registrierte/ausgefallene Kassen dürfen außer Betrieb genommen werden',
  },
  B9: { kind: 'fachlich', text: 'Nur in Betrieb befindliche Kassen dürfen als ausgefallen gemeldet werden' },
  B10: {
    kind: 'fachlich',
    text: 'SEE mit diesem VDA und dieser Zertifikats-Seriennummer bereits gespeichert',
  },
  ...
  B18: {
    kind: 'fachlich',
    text: 'Nur in Betrieb/ausgefallene SEE dürfen endgültig außer Betrieb genommen werden',
  },
